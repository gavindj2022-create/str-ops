...
INSERT INTO checklist_templates (id, property_id, items) VALUES
  ('checklist-millpoint', 'millpoint',
   '[{"group":"Bedrooms","label":"Strip and remake all beds","photo":"required"},{"group":"Bathrooms","label":"Scrub and disinfect bathrooms","photo":"required"},{"group":"Kitchen","label":"Wash dishes, wipe counters, empty fridge","photo":false},{"group":"Waterfront","label":"Rinse and store kayaks","photo":"optional"},{"group":"Finish","label":"Final walkthrough photo","photo":"required"}]'),
  ('checklist-westgate', 'westgate',
   '[{"group":"Bedrooms","label":"Strip and remake all beds","photo":"required"},{"group":"Bathrooms","label":"Scrub and disinfect bathrooms","photo":"required"},{"group":"Kitchen","label":"Restock coffee, supplies, trash bags","photo":false},{"group":"Pool","label":"Skim pool, empty baskets, tidy loungers","photo":"required"},{"group":"Hot tub","label":"Wipe hot tub and log chemistry","photo":"required"},{"group":"Finish","label":"Final walkthrough photo","photo":"required"}]'),
  ('checklist-galena', 'galena',
   '[{"group":"Bedrooms","label":"Strip and remake all beds","photo":"required"},{"group":"Bathrooms","label":"Scrub and disinfect bathrooms","photo":"required"},{"group":"Arcade","label":"Wipe arcade and games area","photo":false},{"group":"Beach","label":"Rinse and store kayaks","photo":"optional"},{"group":"Finish","label":"Final walkthrough photo","photo":"required"}]'),
  ('checklist-hickory', 'hickory',
   '[{"group":"Suites","label":"Reset both king suites","photo":"optional"},{"group":"Bathrooms","label":"Scrub and disinfect bathrooms","photo":"required"},{"group":"Pool","label":"Skim pool and log chemistry","photo":"required"},{"group":"Hot tub","label":"Wipe cabana hot tub and log chemistry","photo":"required"},{"group":"Finish","label":"Final walkthrough photo","photo":"required"}]')
